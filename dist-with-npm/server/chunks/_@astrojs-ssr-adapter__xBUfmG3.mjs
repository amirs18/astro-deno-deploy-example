import { appendForwardSlash, joinPaths, fileExtension, slash, prependForwardSlash, removeTrailingForwardSlash as removeTrailingForwardSlash$1, trimSlashes, isInternalPath, collapseDuplicateTrailingSlashes, hasFileExtension } from '@astrojs/internal-helpers/path';
import { w as decryptString, x as createSlotValueFromString, y as isAstroComponentFactory, h as renderComponent, r as renderTemplate, z as ROUTE_TYPE_HEADER, B as REROUTE_DIRECTIVE_HEADER, A as AstroError, C as i18nNoLocaleFoundInPath, G as ResponseSentError, H as MiddlewareNoDataOrNextCalled, J as MiddlewareNotAResponse, K as originPathnameSymbol, O as RewriteWithBodyUsed, P as GetStaticPathsRequired, Q as InvalidGetStaticPathsReturn, S as InvalidGetStaticPathsEntry, T as GetStaticPathsExpectedParams, V as GetStaticPathsInvalidRouteParam, W as PageNumberParamNotFound, D as DEFAULT_404_COMPONENT, X as ActionNotFoundError, Y as NoMatchingStaticPathFound, Z as PrerenderDynamicEndpointPathCollide, _ as ReservedSlotName, $ as renderSlotToString, a0 as renderJSX, a1 as chunkToString, a2 as isRenderInstruction, a3 as ForbiddenRewrite, a4 as SessionStorageInitError, a5 as SessionStorageSaveError, a6 as ASTRO_VERSION, a7 as CspNotEnabled, a8 as LocalsReassigned, a9 as generateCspDigest, aa as PrerenderClientAddressNotAvailable, ab as clientAddressSymbol, ac as ClientAddressNotAvailable, ad as StaticClientAddressNotAvailable, ae as AstroResponseHeadersReassigned, af as responseSentSymbol$1, ag as renderPage, ah as REWRITE_DIRECTIVE_HEADER_KEY, ai as REWRITE_DIRECTIVE_HEADER_VALUE, aj as renderEndpoint, ak as LocalsNotAnObject, al as REROUTABLE_STATUS_CODES } from './astro/server_etfkpUTe.mjs';
import { bold, red, yellow, dim, blue, green } from 'kleur/colors';
import 'clsx';
import { serialize, parse } from 'cookie';
import { A as ActionError, d as deserializeActionResult, s as serializeActionResult, a as ACTION_RPC_ROUTE_PATTERN, b as ACTION_QUERY_PARAMS, g as getActionQueryString, D as DEFAULT_404_ROUTE, c as default404Instance, N as NOOP_MIDDLEWARE_FN, e as ensure404Route } from './astro-designed-error-pages_CvkaPqs9.mjs';
...
function start(manifest, options) {
  ...
  const handler = async (request, handlerInfo) => {
    if (trace === void 0) {
      try {
        trace = (await import('./astro-adapter_l0sNRNKZ.mjs')).trace;
      } catch {
        trace = null;
      }
    }
