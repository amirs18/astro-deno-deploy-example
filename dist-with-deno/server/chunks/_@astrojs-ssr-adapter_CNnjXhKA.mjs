...
function start(manifest, options) {
  ...
  const handler = async (request, handlerInfo) => {
    if (trace === void 0) {
      try {
        trace = (await import('./astro-adapter_mK6ZKh_2.mjs').then(n => n.d)).trace;
      } catch {
        trace = null;
      }
    }
